...
if stab(ind_change) == 0
    plot(p(ind_change:end),xvar(ind_change:end),'color',blu,'LineWidth',5);
elseif stab(ind_change) == 1
    plot(p(ind_change:end),xvar(ind_change:end),'color',gre,'LineWidth',5);
else
    plot(p(ind_change:end),xvar(ind_change:end),'color',red,'LineWidth',5);
end
...
plot(p(SN),xvar(:,SN),'o','color',dg,'LineWidth',3,'MarkerSize',12);
plot(p(HB),xvar(:,HB),'d','color',br,'LineWidth',3,'MarkerSize',12);
plot(p(BP),xvar(:,BP),'ko','LineWidth',3,'MarkerSize',12);
